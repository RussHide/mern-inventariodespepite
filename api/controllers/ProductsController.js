...
export const editProduct = async (req, res) => {
    try {
        ...
        const editProductData = [req.body.codigo, req.body.nombre, req.body.categoria, req.body.cantidad, req.body.unidad, idEdit]
        await pool.execute('update productos set codigo = ?, nombre = ?, categoria = ?, cantidad = ?, unidad = ? where idProducto = ?', editProductData)

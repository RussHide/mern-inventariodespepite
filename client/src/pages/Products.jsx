  ...
  return (
    <Layout>
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-3 mb-6 place-items-center '>
        ...
        <button className='bg-indigo-200 hover:bg-indigo-400 font-semibold text-gray-700 hover:text-white rounded-lg px-4 py-2 min-w-fit w-full '>Agregar Insumo</button>
      </div>
